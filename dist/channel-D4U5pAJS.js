...
import { r as defineChannelMessageAdapter } from "./channel-message-DUdqhpNg.js";
import { t as zod_exports } from "./zod-DVVrbDMY.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DdGe0zOg.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DQHaDkV-.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-DZhSZPDQ.js";
import { n as createFeishuSendReceipt } from "./send-result-DRTcO0D4.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-QQqD9EWJ.js";
import { t as messageActionTargetAliases } from "./security-audit-CVEBqm8Z.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-C1mAkbIs.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-V6JdF-Yy.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-V6JdF-Yy.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CVfpEPsA.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-Ci33IKKY.js");
