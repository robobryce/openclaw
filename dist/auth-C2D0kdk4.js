...
import { s as loadAuthProfileStoreForRuntime } from "./store-D-rkbyr1.js";
import { n as resolvePluginProviders } from "./providers.runtime-DmHJdvyS.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-DkUcgPLq.js";
import { n as clearAuthProfileCooldown } from "./usage-9iDG1gb8.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CV6_uxAg.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-ChVp5OyG.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-BMG3s9pe.js");
				await openUrl(url);
			},
