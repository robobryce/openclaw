...
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist } from "./node-command-policy-CvyjuhYD.js";
...
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-BH4FZ1-t.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-BaqHRbiP.js";
import { r as upsertPresence } from "./system-presence-CrgH4YjX.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-17opwBBl.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-mhEbGioV.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BicOnFbH.js";
import { t as truncateCloseReason } from "./close-reason-e59_HOCy.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BUNlUjxb.js");
