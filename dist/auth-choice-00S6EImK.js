...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-BzVqn7Iy.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-hNbPYjXs.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-B6WlqkX1.js";
import "./provider-auth-choice-preference-BrvlFRZG.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-p4B02sTl.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-DxZrtFDU.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-BGgCKJl6.js");
