...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-DgYFYTZA.js";
import { i as normalizeProviderIdForAuth } from "./provider-id-DAfV6Kh0.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-D0zA_nj2.js";
...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-KZum-ADU.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-BzVqn7Iy.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CV6_uxAg.js";
import { n as loadModelsConfigWithSource } from "./load-config-m2LYNCJt.js";
import { n as formatErrorWithStack } from "./list.errors-24py0bfI.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-B8OJLPPg.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-BWlHsGLF.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-B8YcanSt.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-zMp4glqe.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BIAPOMHd.js"),
		import("./agent-scope-CqrunIaJ.js"),
		import("./workspace-BvOsleDP.js")
	]);
