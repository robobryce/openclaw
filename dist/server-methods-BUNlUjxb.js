...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-qSKtb3D6.js";
...
import { r as replaceConfigFile } from "./mutate-Wp-h-fwz.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-D508Yjx_.js";
...
import { g as patchPluginSessionExtension } from "./loader-D6aoAKZU.js";
...
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-DPCm5dpS.js";
...
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-kkzugsFG.js";
...
import { o as updateSessionStore } from "./store-DPr34eb5.js";
import "./plugins-C-IBDTFz.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-w65gbqiC.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-E42b5Jxh.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-qg_gvOtp.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DQBj0AYb.js";
...
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-Ry3xff6Y.js";
...
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-CtTTSVo_.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Bm7KxKlj.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BDMOITFS.js";
...
import { l as projectOutboundPayloadPlanForMirror, r as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-DQPtyZCM.js";
...
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-sVYlykXu.js";
...
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-D7_sz6rJ.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-DBjKoU4O.js";
import { n as normalizePollInput } from "./polls-CkSUOYU1.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-YVqJGXAW.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-1mtM11vg.js";
import "./target-resolver-Ue08B5Gn.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-BAt-Qwfv.js";
...
import { r as resolveOutboundTarget } from "./targets-DV9YCk37.js";
import { n as resolveAgentIdentity } from "./identity-BJqKZTLs.js";
import { s as clearSessionQueues } from "./queue-D2T1Llc9.js";
...
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CPZnyTb-.js";
...
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-CQXLN4eJ.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-DnFo8HTF.js";
...
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-Ch-ANr8c.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BLXjEgjz.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BRDJemoE.js";
...
import { r as agentCommandFromIngress } from "./agent-command-BHSQnigh.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-1JzlgJZh.js";
import { n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-CvyjuhYD.js";
...
import { r as invokeNativeHookRelay } from "./native-hook-relay-CTXeuB-N.js";
import { t as canExecRequestNode } from "./exec-defaults-BbQcMwAd.js";
...
import { t as listSkillCommandsForAgents } from "./skill-commands-aZZPAwBs.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-AzQwRr27.js";
...
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-yoCm0PYx.js";
import { a as listRealtimeVoiceProviders, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, k as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage, x as recordTalkObservabilityEvent, y as createTalkSessionController } from "./session-runtime-TUPp0d49.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CordmNM_.js";
import { n as createOutboundSendDeps } from "./deps-BVRJdPjY.js";
import "./agent-CWpCFxIi.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-StYwRv92.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DDrCqimF.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-i5utCbfA.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DmPuGZDv.js";
import "./server-constants-BH4FZ1-t.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-yIpqErYr.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-YOu0u7Fw.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-huC9S4hC.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-HKMhV2hp.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-Dpjp9hVM.js";
import { t as loadProviderUsageSummary } from "./provider-usage-f7mbsQBY.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BxqsSVIP.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DRlgulL5.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-B8-j8S3a.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DWZH91NY.js";
import { s as performGatewaySessionReset } from "./session-reset-service-Cx-Xkknh.js";
import { t as buildChannelUiCatalog } from "./catalog-BKcRZ3b3.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-ZAmA2Jfd.js";
import { s as normalizeUpdateChannel } from "./update-channels-bySiLWNx.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CVK21-Uv.js";
import { t as readConfiguredLogTail } from "./log-tail-C0Hta4ou.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DpnTQ4RH.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-D4t5ZW0z.js";
import { t as buildChannelAccountSnapshot } from "./status-CYF7TM0V.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DaCjDy1O.js";
import { t as installSkill } from "./skills-install-D3LzghmD.js";
import { r as readPackageVersion } from "./package-json-ujCZspLI.js";
import { t as getStatusSummary } from "./status.summary-CHRYLd3l.js";
import "./status-D7LC_NL5.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-B-VNfnCq.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-__Pc-KeT.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-DmpFTImw.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-B89vNpup.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DSszMkvm.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CcfqJLy9.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Cs9El9m1.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cp4qMH4Y.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-D2g2H_zS.js";
import "./heartbeat-runner-BWCtOegr.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-D01ZRaQk.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-BaqHRbiP.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CrgH4YjX.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-mhEbGioV.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-CvZHn8hT.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-ALydpsgQ.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-B9xyTmvv.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BTInuFlq.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C2IC1GUB.js");
