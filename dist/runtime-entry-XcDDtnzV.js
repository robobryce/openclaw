...
import { n as privateFileStoreSync, t as privateFileStore } from "./private-file-store-B5mHCqlS.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-B2b8_Dfb.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, v as resolveRealtimeVoiceAgentConsultToolsAllow, x as recordTalkObservabilityEvent, y as createTalkSessionController } from "./session-runtime-TUPp0d49.js";
import { f as resolveRealtimeVoiceFastContextConsult, m as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-DHQurcps.js";
...
import "./api-BjfsqBKw.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-BjitAZEQ.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-2TorlF5Z.js";
import { t as resolveVoiceResponseModel } from "./response-model-r9z7WuTA.js";
import { t as isProviderStatusTerminal } from "./call-status-C0TWmTsI.js";
import { t as getHeader } from "./http-headers-DzhbE48_.js";
...
function buildConsultPolicyGuidance(config) {
	if (config.toolPolicy === "none" || config.consultPolicy === "auto") return;
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-D58F2oN5.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-CwHD1mdI.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-Cf9Tal3H.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Cm5BZhaw.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-B8XlSleS.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-bWRE_FLZ.js");
