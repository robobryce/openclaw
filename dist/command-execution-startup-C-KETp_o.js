...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CYtfpbi1.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CzWnlYMj.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Dm2-N131.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CWr1vhZr.js");
	if (params.argv) {
