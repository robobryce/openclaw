import { o as resolveConfigPath, u as resolveGatewayPort } from "./paths-BplLTi2s.js";
...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-BWt8QPer.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-DISobFMn.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
