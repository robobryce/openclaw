...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-2MIOFP_D.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-Dj_Y93TT.js");
	const { buildPluginSnapshotReport } = await import("./status-BQQm5bsZ.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-CeJQdrIa.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-BP2XkWWT.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-BXSwYm3S.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-CdaRdEDg.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-DMpTtyPV.js");
