...
import { i as resolveRootPathSync, r as resolveRootPath } from "./root-path-Cj336NQP.js";
import { i as openRootFileSync, n as matchRootFileOpenFailure, r as openRootFile } from "./root-file-BmXzNSx2.js";
import { c as isRecord, d as resolveConfigDir, p as resolveUserPath } from "./utils-Cs_zUMxj.js";
...
import { c as readRootStructuredFileSync, o as readRootJsonObjectSync, u as tryReadJsonSync } from "./json-files-DbKnK_Nw.js";
import { n as MANIFEST_KEY } from "./legacy-names-4mm_GxYL.js";
import { i as normalizeModelCatalogProviderId, n as normalizeModelCatalogProviderRows, r as buildModelCatalogMergeKey, t as normalizeModelCatalog } from "./normalize-DwHRtfuW.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-DkxR1MaB.js";
import { t as parseJsonWithJson5Fallback } from "./parse-json-compat-DlawyT4z.js";
import { t as normalizeManifestCommandAliases } from "./manifest-command-aliases-DxKEnEBn.js";
import { r as createPluginCacheKey, t as PluginLruCache } from "./plugin-cache-primitives-CFaJUbTy.js";
import { n as resolveBundledPluginsDir, r as resolveSourceCheckoutDependencyDiagnostic } from "./bundled-dir-_ozNzzFg.js";
import "./path-safety-Doo-IYF6.js";
import "./boundary-path-DnB5hw2r.js";
...
//#endregion
export { isPrereleaseResolutionAllowed as A, planProviderIndexModelCatalogRows as C, compareOpenClawReleaseVersions as D, loadOpenClawProviderIndex as E, parseRegistryNpmSpec as M, validateRegistryNpmSpec as N, formatPrereleaseResolutionError as O, resolvePackageExtensionEntries as S, planManifestModelCatalogSuppressions as T, normalizeBundlePathList as _, resolvePluginSourceRoots as a, getPackageManifestMetadata as b, validatePackageExtensionEntriesForInstall as c, CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH as d, CODEX_BUNDLE_MANIFEST_RELATIVE_PATH as f, mergeBundlePathLists as g, loadBundleManifest as h, resolvePluginCacheInputs as i, isPrereleaseSemverVersion as j, isExactSemverVersion as k, buildBundledPluginLoadPathAliases as l, detectBundleManifestFormat as m, buildPluginDependencyStatus as n, tracePluginLifecyclePhase as o, CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH as p, normalizePluginDependencySpecs as r, tracePluginLifecyclePhaseAsync as s, discoverOpenClawPlugins as t, normalizeBundledLookupPath as u, DEFAULT_PLUGIN_ENTRY_CANDIDATES as v, planManifestModelCatalogRows as w, loadPluginManifest as x, PLUGIN_MANIFEST_FILENAME as y };
