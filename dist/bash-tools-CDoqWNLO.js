...
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-CyEfEYg-.js";
...
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-BvGD_Bil.js";
import { W as splitShellArgs, d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-QU8GYl8K.js";
import { t as killProcessTree } from "./kill-tree-D-YDuF5p.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bzghcb_l.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-B-FLT_xh.js";
...
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-S_dUTvKW.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bm7KxKlj.js";
import { o as failedTextResult, v as textResult } from "./common-DPSDd5uL.js";
import { t as callGatewayTool } from "./gateway-DTCHeh_G.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand, v as buildCommandPayloadCandidates, x as describeInterpreterInlineEval } from "./exec-approvals-allowlist-zcFguJdt.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DRc_HOdA.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, _ as normalizeExecSecurity, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-C9iaDVpr.js";
...
import { t as sendMessage } from "./message-BYyZ5Mg6.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-DKKf3Axj.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DvDSTIts.js";
import { t as formatDurationCompact } from "./format-duration-DWpWpAX0.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-Dx_Lq9iA.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-CWPNQnu8.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-V3B0Tw2Y.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-OCLbTY8m.js";
import { t as getProcessSupervisor } from "./supervisor-D12oWXab.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-BHVrLdzk.js";
import { n as detectPolicyInlineEval } from "./policy-C3Sal6v0.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-B50QSolZ.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-CDYU3Sgo.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-COHTzm4e.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-DnyqTEWn.js"));
