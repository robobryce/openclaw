...
import { n as matrixSetupAdapter } from "./setup-core-DcKSjaMc.js";
...
import { t as withResolvedActionClient } from "./client-T59ILQ4C.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-UKJoSDK0.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-B-AyJrXF.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DiEOOGss.js");
