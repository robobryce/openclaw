...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-D1d5wmH4.js";
import { n as channelRouteDedupeKey } from "./channel-route-DfppJbyJ.js";
import { n as getLoadedChannelPlugin } from "./registry-CA3xQtyM.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-C-IBDTFz.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-C9iaDVpr.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-sVYlykXu.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-Dys8VGzY.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-7L1cUGSW.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-BKHHrkAG.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BqdU5rtC.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BYXP__0Q.js";
import { l as roleScopesAllow } from "./pairing-token-DmkbRdbM.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-BfbEaNK4.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Cs9El9m1.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cp4qMH4Y.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-D9tyKjMB.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-CiOrG5QN.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-CbWmp_vN.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BsOaWmRn.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
