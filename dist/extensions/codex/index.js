...
import { n as MIGRATION_REASON_TARGET_EXISTS, o as createMigrationItem, s as createMigrationManualItem, v as summarizeMigrationItems } from "../../migration-De8hThQQ.js";
import { i as writeMigrationReport, n as copyMigrationFileItem, t as archiveMigrationItem } from "../../migration-runtime-DyMP5dnW.js";
import { t as createCodexAppServerAgentHarness } from "./harness-CWZdB_SP.js";
import { t as buildCodexMediaUnderstandingProvider } from "./media-understanding-provider-Cpkf3q9A.js";
import { t as buildCodexProvider } from "./provider-yHSnidDN.js";
import { f as describeControlFailure, r as formatCodexDisplayText } from "./command-formatters-C0dbiJmf.js";
import { n as handleCodexConversationInboundClaim, t as handleCodexConversationBindingResolved } from "./conversation-binding-CeIMTENT.js";
...
async function handleCodexCommand(ctx, options = {}) {
	const { handleCodexSubcommand } = await import("./command-handlers-PkvU5jCM.js");
	try {
