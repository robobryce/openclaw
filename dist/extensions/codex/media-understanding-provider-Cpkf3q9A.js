import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-to6Z1S4a.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-zsLr81yf.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-C6PFrB1m.js";
import { r as readModelListResult } from "./models-DBM0G8xA.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-PUTbftWV.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
