...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "../../webhook-request-guards-CvzDRC79.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, h as parseRealtimeVoiceAgentConsultArgs, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "../../session-runtime-BFeVJjCF.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "../../realtime-voice-CUn3L27Q.js";
...
import "./api-BaonOX9t.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CFdz0nfP.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-aI2xOQ9r.js";
import { t as resolveVoiceResponseModel } from "./response-model-CxhUWy8r.js";
import { t as isProviderStatusTerminal } from "./call-status-BnbfAihj.js";
import { t as getHeader } from "./http-headers-CE3w10Ok.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-MuE0flgF.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-QXAOuAyA.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DOSYylkH.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-DwUH_e6y.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-CLDOgzNq.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DqkEVyBN.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-xosenLug.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-B8VhUSms.js");
