...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "../../reply-payload-CShZCAWP.js";
...
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-Bx1Oh13v.js";
import { p as DiscordError } from "./discord-BBWAxrgt.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-Bykb5YJJ.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-BlQjETSR.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-CMJVNHHt.js");
