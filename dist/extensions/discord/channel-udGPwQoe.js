...
import { n as resolveTargetsWithOptionalToken } from "../../target-resolvers-C_ECA6Fq.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "../../allowlist-config-edit-CYUmCq6t.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BTagatb1.js";
import "./channel-api-5GVvUMr5.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-Bx1Oh13v.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CZnc7N3A.js";
import { t as getDiscordRuntime } from "./runtime-vGqAwY89.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-ChFjq-MF.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BEI3opFx.js";
import { t as discordMessageActions$1 } from "./channel-actions-BMlJV--J.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-C31kMwAI.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-Dw4Bjetg.js";
import { n as discordOutbound } from "./outbound-adapter-B-QeMBuN.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DrWJ3Z2P.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-7DhIySUo.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-yoPb30vD.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-D3ufVr0c.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-SF7WH8AO.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-D_nqLrGC.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-BOwTV-W7.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-DpLOV2tG.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-BGwSssEF.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-CeL2fhuV.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DDXSe1MR.js");
