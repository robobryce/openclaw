...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "../../webhook-request-guards-CvzDRC79.js";
import { t as normalizeWebhookPath } from "../../webhook-path-CabhZhdJ.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "../../webhook-targets-BaQichvL.js";
import "../../security-runtime-Bl5xB_Et.js";
import "../../string-coerce-runtime-CQu4jhHk.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DeejK9CN.js";
import "./secret-input-BA1uVOMd.js";
import { t as getBlueBubblesRuntime } from "./runtime-DccANet2.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-CAPPqLJ3.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CeIaYb1S.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-B0fyzaTJ.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-Cygh82Cs.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
