...
import "./accounts-Cuf3-_zo.js";
import "./runtime-api-D3D3duUq.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Dbv0Bn8J.js";
import { t as sendMessageZalo } from "./send-KBjL4Gr5.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CMhyGxF_.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C2zDTvRu.js");
