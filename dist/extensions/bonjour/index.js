...
var bonjour_default = definePluginEntry({
	...
	register(api) {
		api.registerGatewayDiscoveryService({
			id: "bonjour",
			advertise: async (ctx) => {
				const [{ startGatewayBonjourAdvertiser }, { registerUncaughtExceptionHandler, registerUnhandledRejectionHandler }] = await Promise.all([import("../../advertiser-C5AtCN7d.js"), import("../../plugin-sdk/runtime.js")]);
