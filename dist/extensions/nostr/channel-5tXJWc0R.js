...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "../../channel-config-helpers-B1VUZOf-.js";
...
import { n as resolveInboundDirectDmAccessWithRuntime, t as createPreCryptoDirectDmAuthorizer } from "../../direct-dm-access-ChCmPDXN.js";
import { t as createDirectDmPreCryptoGuardPolicy } from "../../direct-dm-guard-policy-DExn9lqz.js";
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "../../extension-shared-DA6ep8iB.js";
import { t as attachChannelToResult } from "../../channel-send-result-D0ZVWJnp.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-l4tlcbqB.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes$1, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-D5lozOQ9.js";
import { t as DEFAULT_RELAYS } from "./default-relays-BTHEiDds.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-j2ejyGUV.js");
