...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-DXzuOZEO.js";
import "../../ssrf-runtime-2NoQmkSk.js";
import "./runtime-api-BMkxzvVz.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("../../src-D7Bq7e5t.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-BsnEUpW3.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
