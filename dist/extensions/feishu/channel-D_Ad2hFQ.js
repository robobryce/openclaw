...
import { c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "../../payload-EmBOkJAy.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "../../channel-config-helpers-B1VUZOf-.js";
import "../../text-runtime-DiIsWJZ1.js";
import { n as describeAccountSnapshot } from "../../account-helpers-Cc3Yu4Gm.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "../../core-DAU5xPEB.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "../../channel-policy-BeL24_Dy.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "../../setup-wizard-helpers-6I3G81wu.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "../../status-helpers-BthQYPrV.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-B81DDycf.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DjPzLIf6.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-CncS2MNn.js";
import "./card-interaction-sIBqB_eI.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-Dk8jkFFq.js";
import { t as messageActionTargetAliases } from "./security-audit-Jz14e-lo.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-NLwROl9m.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-JcTopldv.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-zaZJ4fiJ.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-DxGpd8_a.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-BP8elvRo.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-BP8elvRo.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-DaNoL1kv.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Br88CPp2.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DLyZKybH.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-Cb_R486N.js");
