...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "../../reply-payload-CShZCAWP.js";
import { n as fetchWithSsrFGuard } from "../../fetch-guard-CEd5cd5u.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "../../channel-streaming-B7SapjwD.js";
...
import { c as resolveOpenDmAllowlistAccess } from "../../dm-policy-shared-D7EtFi3S.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "../../webhook-request-guards-CvzDRC79.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "../../binding-routing-ZccGvpNd.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-B81DDycf.js";
import { i as resolveReceiveIdType } from "./targets-DjPzLIf6.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-ZNeyqcqx.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-CncS2MNn.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-sIBqB_eI.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-NLwROl9m.js";
import { t as getFeishuRuntime } from "./runtime-CAPlgwYs.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-Cb49rSfL.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-DUQl51h8.js";
import "./runtime-api-XXZhRv5C.js";
import { _ as shouldSuppressFeishuTextForVoiceMedia, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent, v as normalizeFeishuExternalKey } from "./send-vGlsqfLq.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-B5JDtfpb.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-KlOdbDqY.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-R31MZ6PO.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BZajPzfc.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BZajPzfc.js");
