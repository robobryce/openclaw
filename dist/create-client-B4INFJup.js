...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-AS-sLvVq.js";
import "./config-DcFe9VES.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-QCSpqVmM.js"), import("./logging-hrMVO9H7.js")]).then(([sdkModule, loggingModule]) => ({
