...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores } = await import("./doctor-auth-flat-profiles-xcaKGAie.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-CKkBxQX7.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth--QAl18Sg.js");
	const { buildGatewayConnectionDetails } = await import("./call-DISobFMn.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-DQ00rWEU.js");
	const { randomToken } = await import("./onboard-helpers-BMG3s9pe.js");
...
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-5VfknTZm.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-CCZ7Iy1-.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-B8PvjIfI.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-DIyTI2Un.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-BgarLbG-.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-CgxxFlMv.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-s2MyVNhv.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-1TcPZlKh.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-m5mgG2gi.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-BfyjqY2H.js");
	await noteSessionTranscriptHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./doctor-cron-637Lxv5q.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-DbeeWSeJ.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-BdJDavKC.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-C2z2ypd5.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-CkkmLfg8.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-DjgZalgj.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DSGLpA4o.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-BWfpAM2Y.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadModelCatalog } = await import("./model-catalog-Ce4_TzWS.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-BkmaTNZN.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-CK6X1o3S.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-ICeHSWel.js");
	const { note } = await import("./note-DQ00rWEU.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-CwOY9X0W.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-BL8U2Hkn.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-C-ic7I48.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-BF00DgIK.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-C6onExcO.js");
...
async function runWhatsappResponsivenessHealth(ctx) {
	const { noteWhatsappResponsivenessHealth } = await import("./doctor-whatsapp-responsiveness-BZO9c-1J.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-HvXjHuns.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-CysBePH8.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-5PpJttWT.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-CqjX4YvY.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-BMG3s9pe.js");
	const { CONFIG_PATH, replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-CFE7Ml-o.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-s2MyVNhv.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-DAY8LFRc.js");
	const { note } = await import("./note-DQ00rWEU.js");
