...
import { t as CONFIG_PATH } from "./paths-BplLTi2s.js";
import { t as formatCliCommand } from "./command-format-ut6bcRZg.js";
import { c as isRecord$1 } from "./utils-Cs_zUMxj.js";
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-BgzzIHyp.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-BQglYFe1.js";
import { r as normalizeChatChannelId } from "./ids-D3yDKGxF.js";
import { r as normalizeProviderId$1 } from "./provider-id-DAfV6Kh0.js";
import { i as setPathExistingStrict } from "./path-utils-DmVtHaOt.js";
import { n as discoverConfigSecretTargets } from "./target-registry-Xm-KEvst.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-qSKtb3D6.js";
import { n as formatConfigIssueLines } from "./issue-format-CW8ofM72.js";
import { r as normalizeTalkSection } from "./talk-Bi_vfhaD.js";
import { n as collectConfiguredModelRefs } from "./model-refs-DsghvnTf.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-DVbnPa7G.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DgpdIz4K.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-D42aQk_c.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BBOIEXje.js";
import { n as getLoadedChannelPlugin } from "./registry-CA3xQtyM.js";
import { i as listRouteBindings } from "./bindings-COarL8Wl.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-Fm8TQWRh.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-1emCcJ1U.js";
import { t as note } from "./note-CGsx0Ar8.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DJLOE9Pe.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Bo697uxR.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BF0PruJQ.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BqaKDPEi.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BKWPJVv5.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DQgoOqvo.js";
import { t as asObjectRecord } from "./object-DRcOqsyW.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CoT4JXTm.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-B027Wgf6.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DEQ6ghWP.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BC5AqqJY.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-B3vWoIHD.js");
		emitDoctorNotes({
			note,
