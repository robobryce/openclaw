...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-D508Yjx_.js";
import { o as resetModelCatalogCache } from "./model-catalog-DZH9pC25.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-sVYlykXu.js";
import { r as resetDirectoryCache } from "./target-resolver-Ue08B5Gn.js";
...
import { _ as resolveHooksConfig } from "./hooks-DrHNNp_n.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-b8tGf2nu.js";
import { i as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Cs9El9m1.js";
...
import { t as buildGatewayCronService } from "./server-cron-Db-1UByV.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-E_rckS3U.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-m0OtbGtx.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BjNzjwAn.js"), import("./gmail-watcher-lifecycle-CnVkjZbl.js")]);
