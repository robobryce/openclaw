...
import { i as extractFirstTextBlock } from "./chat-message-content-CeiAuZxW.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-uHLKiRsQ.js"),
			import("./client-sqSK8WMr.js"),
			import("./client-start-readiness-3bm74VMD.js"),
			import("./method-scopes-DSzk-B8I.js"),
			import("./client-info-BAmbbsVw.js")
		]);
