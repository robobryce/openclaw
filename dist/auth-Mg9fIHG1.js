...
import { s as loadAuthProfileStoreForRuntime } from "./store-C57uqpQM.js";
import { n as resolvePluginProviders } from "./providers.runtime-BMV6Bp-8.js";
import "./model-selection-shared-BL9Kfr1K.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-CXZVkqAd.js";
import { n as clearAuthProfileCooldown } from "./usage-NP3mbK0t.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-D3BbCOIm.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Ds6sQVQ8.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-D1Zfjfbb.js";
import { t as createClackPrompter } from "./clack-prompter-BdpaC1y6.js";
import { n as logConfigUpdated } from "./logging-tup7OLmc.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-DA202yMs.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-B_-1jnOx.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-C47qqizF.js";
import { t as isRemoteEnvironment } from "./remote-env-DBgKjTtj.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-CEH-pqb8.js");
				await openUrl(url);
			},
