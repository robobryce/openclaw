...
import { i as getBundledChannelSetupPlugin } from "./bundled-DgpdIz4K.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CA3xQtyM.js";
import "./plugins-C-IBDTFz.js";
import "./logging-CBzL0sMb.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-BP7s3d0b.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-D_Ft6gLP.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-0MvO7C3B.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CLAbCTy7.js";
...
import { n as resolveLogFile } from "./log-tail-C0Hta4ou.js";
import { t as parseLogLine } from "./parse-log-line-SpmPbB9n.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BVSDdULr.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-CtGq_6hA.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-DvcyBHR5.js";
import { t as channelsListCommand } from "./list-DBCmJ2rR.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-Bx6BGTa6.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-C4j1Z1E5.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-DY78RD6V.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-DDqEQ19q.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-uyyd5Eob.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DOMQXvcK.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DahX2oKt.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Cvvn7Oey.js");
