...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { buildPluginSnapshotReport } = await import("./status-DKJhTn0b.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-D-2g9nxc.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CVTaXw_E.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BAAEi8BQ.js");
