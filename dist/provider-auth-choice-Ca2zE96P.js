...
import { n as openUrl } from "./browser-open-Br_1bzye.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DSB44ade.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-NIHuHDJT.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-B_-1jnOx.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-BqFGsyY4.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-lnpQXs4A.js") };
