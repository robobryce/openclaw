...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-BgzzIHyp.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-BOQQhVEM.js";
import "./ssrf-runtime-D54GqMPE.js";
import "./retry-runtime-rL3azkqM.js";
import "./secret-input-runtime-BtgRIb7y.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Cvi-6Mv4.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-Dfr5Ex2F.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DlaWhTUI.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-Bph0pbU6.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BcQbH_Ne.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CNwd8CZA.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-AS-sLvVq.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-QCSpqVmM.js"), import("./logging-hrMVO9H7.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BE27RUD7.js").then((credentialsReadModule) => ({
