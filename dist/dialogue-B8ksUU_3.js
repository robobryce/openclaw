import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-JkZ_IVGt.js";
import { r as loadCrestodianOverview } from "./overview-B5sP9Z2A.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-D37_OcGh.js")).planCrestodianCommand)({
		input,
		overview
	});
