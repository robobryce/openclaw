...
import { r as loadPluginMetadataSnapshot, t as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-w8O5Vqt5.js";
import { g as isPluginEnabledByDefaultForPlatform } from "./installed-plugin-index-store-DfTHx5bO.js";
import { l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig } from "./config-state-DdLKyreN.js";
import { g as createPluginRegistryIdNormalizer, n as loadPluginManifestRegistryForPluginRegistry, r as normalizePluginsConfigWithRegistry } from "./plugin-registry-DgYFYTZA.js";
import { t as isSafeChannelEnvVarTriggerName } from "./channel-env-var-names-D4tGjOoQ.js";
import { _ as hasExplicitManifestOwnerTrust, b as passesManifestOwnerBasePolicy, v as isActivatedManifestOwner, x as resolveManifestOwnerBasePolicyBlock, y as isBundledManifestOwner } from "./bundled-DgpdIz4K.js";
import { a as collectConfiguredAgentHarnessRuntimes, i as listPotentialConfiguredChannelPresenceSignals, n as listExplicitlyDisabledChannelIdsForConfig, r as listPotentialConfiguredChannelIds, t as hasMeaningfulChannelConfig } from "./config-presence-DnVNKvrx.js";
import { t as collectPluginConfigContractMatches } from "./config-contracts-CMVkRJlt.js";
import { t as resolveManifestActivationPluginIds } from "./activation-planner-CWaMmej5.js";
import { G as resolveMemoryDreamingConfig, K as resolveMemoryDreamingPluginConfig, _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID, q as resolveMemoryDreamingPluginId } from "./dreaming-DhDhoi2f.js";
