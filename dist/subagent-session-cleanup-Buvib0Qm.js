...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReply } from "./run-wait-BdYb1ZJD.js";
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-BDjgBWhY.js");
