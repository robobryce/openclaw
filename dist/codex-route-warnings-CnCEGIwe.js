import { t as AGENT_MODEL_CONFIG_KEYS } from "./model-refs-DsghvnTf.js";
...
function resolveRuntime(params) {
	return normalizeString(params.env?.OPENCLAW_AGENT_RUNTIME) ?? normalizeString(params.agentRuntime?.id) ?? normalizeString(params.defaultsRuntime?.id) ?? "codex";
}
...
function repairCodexSessionStoreRoutes(params) {
	...
	for (const [sessionKey, entry] of Object.entries(params.store)) {
		...
		if (!changedModelRoute && !changedFallbackNotice && !changedAuthOverride) continue;
