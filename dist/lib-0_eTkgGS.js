...
import { t as require_src } from "./src-yf86kw-T.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-BlRaGi2m.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BJbljEyC.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Ct-61h70.js";
import { l as toRatio, n as decodeString } from "./Util-Cv5KQL4c.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-Bsg_2cRT.js";
import { t as APEv2Parser } from "./APEv2Parser-Cu77-_U7.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DXXndp3X.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DaTx_Jl2.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-W8MqDD1n.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Z1GyhOuM.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Ctfrqj6B.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DrvMuQav.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BBjsVKTU.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Cq2HQInx.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CYEapGKR.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BUIqMWUV.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BZ9lXCSu.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-C_ePE6-c.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BcFMVk3A.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-MjZgc_vX.js")).WaveParser;
	}
};
//#endregion
