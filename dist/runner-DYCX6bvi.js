...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CJLdAKfb.js";
import { t as providerSupportsCapability } from "./provider-supports-DmYZNcU5.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CAVhmdQg.js";
...
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-D9j2gm-R.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Ce4_TzWS.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CZc9fnLT.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CzavWdsH.js");
