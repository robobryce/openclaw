...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-DvJdq55B.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
	return await (await import("./runtime-DuRDaZnF.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-DuRDaZnF.js")).withDurableMessageSendContext(params, run);
}
