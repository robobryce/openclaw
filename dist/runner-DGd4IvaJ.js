...
import { n as findNormalizedProviderValue } from "./provider-id-DAfV6Kh0.js";
...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CrGM4jU-.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-BgNEXalX.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DOmAUQlT.js";
import { t as providerSupportsCapability } from "./provider-supports-DmYZNcU5.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-BRHnlxQQ.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-CvDK8jgR.js";
import { t as buildRandomTempFilePath } from "./temp-download-ssPILp15.js";
import "./temp-path-DNgkxoq3.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-DQgzFcSo.js";
import "./shared-CCW3b9_z.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CN1ZGcok.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-Dau6yp-g.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-abB3a9GL.js");
