...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-BVhylegS.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BOmJE1LU.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-CxpmbvWK.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-CdpOt_5j.js");
			...
			const { statusCommand } = await import("./status-DfMnmC-3.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-B8u3t2Js.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CqGn5ZVq.js");
	...
	"agents-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { agentsListCommand } = await import("./agents-BxtqpcLX.js");
	...
	"tasks-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksListJsonCommand } = await import("./tasks-json-CqEtG7Nt.js");
	...
	"tasks-audit": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksAuditJsonCommand } = await import("./tasks-json-CqEtG7Nt.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-ByO072CA.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-ChpW1Bcy.js");
