...
import { t as ConfigMutationConflictError } from "./mutate-Wp-h-fwz.js";
...
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BX7yEkzn.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit--ez-uaLQ.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-gq3x7weI.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DPnYcxIJ.js";
import { n as applyAuthChoice } from "./auth-choice-00S6EImK.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BrvlFRZG.js";
import { i as setupChannels } from "./onboard-channels-CInI6iCl.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-D2PvKXSm.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-Cez3SCGD.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DvT9lGrH.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-BsXpA4Lv.js";
import { t as applyPrimaryModel } from "./provider-model-primary-K3JMF6Np.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BfTDi5z2.js";
import { t as promptCustomApiConfig } from "./onboard-custom-9MTtRlQy.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-BYl0tmoH.js";
import { n as formatHealthCheckFailure } from "./health-format-DhfIt5n0.js";
import { n as healthCommand } from "./health-Ccx8h1iS.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DphW9Cwq.js";
import { t as setupSkills } from "./onboard-skills-BPVcSJae.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-MzZQOGxS.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CqYFQuC3.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-YWg6Ofw1.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-vHn9GGs5.js");
