...
import { t as getMSTeamsRuntime } from "./runtime-api-CWqDTzTZ.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-BmbHM5yV.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DmXN28Ja.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DzXzA18x.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-Bk_kAQXq.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
