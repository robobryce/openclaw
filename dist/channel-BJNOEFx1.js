...
import { i as createChatChannelPlugin } from "./core-C1k2IcgS.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-qowxG5rD.js";
...
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CsgBbkdq.js";
import { t as getDiscordRuntime } from "./runtime-BIKjVJFK.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-D2y_DuzW.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BXR1gJRw.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-CG0uDTtC.js";
import { t as discordMessageActions$1 } from "./channel-actions-SyBe0Hex.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-e4nlujyU.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DLd6Lmu2.js";
import { n as discordOutbound } from "./outbound-adapter-DRMUcOBX.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BiwUARzV.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-oe-mUE31.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-UdiFaTcf.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-gpbBgy9r.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DWq3AC8N.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DpmmLIZ4.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-B4lhk77w.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DNqzDsa5.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DOug0AYm.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-pPjkAKP7.js");
