...
import { r as readModelListResult } from "./models-DoadQ3vs.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-Bgcgl4Ki.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
