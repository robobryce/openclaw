...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-BvGD_Bil.js";
...
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BJ8-WNYO.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-OCATF0Ci.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DmtUGjfr.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-7PVxQ5yp.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-CH1C-lxX.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-BAb_wkh-.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CHU4IzGV.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DG4dt6H_.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CffA-kn2.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DbAMLSJq.js");
		emitDoctorNotes({
			note,
