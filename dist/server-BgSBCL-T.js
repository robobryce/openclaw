...
import { a as CANVAS_HOST_PATH, c as isA2uiPath, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload } from "./a2ui-DyKQUR-p.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-By_Bxn1u.js");
