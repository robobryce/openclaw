...
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-DZCuKDc0.js";
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-KLHAXVXG.js";
import { n as VERSION } from "./version-C0yxKKZ8.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-BTfIvFux.js";
...
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CkYPLluX.js";
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-1eDLn1wc.js";
import { a as logWarn } from "./logger-C190dODJ.js";
import { i as getRuntimeConfig } from "./io-qSKtb3D6.js";
import { A as resolveShellWrapperTransportArgv, C as POSIX_SHELL_WRAPPERS, F as extractEnvAssignmentKeysFromDispatchWrappers, M as POSIX_INLINE_COMMAND_FLAGS, P as resolveInlineCommandMatch, R as unwrapKnownDispatchWrapperInvocation, U as normalizeExecutableToken, W as splitShellArgs, b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, j as unwrapKnownShellMultiplexerInvocation, k as isShellWrapperInvocation, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-QU8GYl8K.js";
import "./config-DgbftrzN.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-tc_CMlix.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-C0PG-xiO.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-Bb6hRR6u.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-9TRzWgZG.js";
import { a as getActivePluginRegistry } from "./runtime-DPCm5dpS.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-CMkEyNv9.js";
import { t as getMachineDisplayName } from "./machine-name-gkQJscAl.js";
import { c as analyzeArgvCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist, x as describeInterpreterInlineEval } from "./exec-approvals-allowlist-zcFguJdt.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-DRc_HOdA.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-E8InmqkL.js";
import { t as formatHelpExamples } from "./help-format-BCO0afbC.js";
import { n as detectPolicyInlineEval } from "./policy-CRs11cga.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-StYwRv92.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-EvevpVag.js";
import { t as resolveNodeService } from "./node-service-DUHzGDuq.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-B90azbt3.js");
