import { g as unscopedPackageName, v as resolveSafeInstallDir } from "./channel-catalog-registry-CPYXS47s.js";
import { p as resolveUserPath, t as CONFIG_DIR } from "./utils-Cs_zUMxj.js";
import { n as MANIFEST_KEY } from "./legacy-names-4mm_GxYL.js";
import { t as parseFrontmatter } from "./frontmatter-D5omGTtf.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/hooks/install.ts
let hookInstallRuntimePromise;
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-BWihcPaU.js");
