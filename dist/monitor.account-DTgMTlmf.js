...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-DeVcgKPL.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-DdGe0zOg.js";
import { i as resolveReceiveIdType } from "./targets-DQHaDkV-.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-Ca0DrUbX.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-DZhSZPDQ.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-DRTcO0D4.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-C1mAkbIs.js";
...
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-DqOYsz2M.js";
import "./runtime-api-BbSg5KD9.js";
import { _ as shouldSuppressFeishuTextForVoiceMedia, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent, v as normalizeFeishuExternalKey } from "./send-DF2QXdSc.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DKeod11N.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-CCiCAlCG.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-5klrrq-F.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DUqUu2oe.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DUqUu2oe.js");
