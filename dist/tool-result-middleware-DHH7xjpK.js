...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-Djx4qmq3.js";
import "./model-selection-BOeJUkj5.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-Bf1kL3h7.js";
import { t as log$1 } from "./logger-TBztR_Sc.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-R5UEMBKm.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DOIQC_Xb.js");
