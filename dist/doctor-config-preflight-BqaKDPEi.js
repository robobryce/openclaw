...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-qSKtb3D6.js";
import { n as formatConfigIssueLines } from "./issue-format-CW8ofM72.js";
import { t as note } from "./note-CGsx0Ar8.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DJLOE9Pe.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-trrAc9Oj.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-B8PvjIfI.js");
