...
import { r as readModelListResult } from "./models-D4n4obh2.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-DP73jKGH.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
