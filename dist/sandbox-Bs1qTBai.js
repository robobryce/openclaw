...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-BOxWK7ju.js";
import "./config-DgbftrzN.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Bn82tdyb.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-VxuJJe5-.js";
import { n as isToolAllowed } from "./tool-policy-Dw4pw98a.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BSXUJKVa.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BM6OhY6Q.js";
import { f as isSameSsrFPolicy } from "./ssrf-C-oxBlw8.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BlLdxEJN.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-CIWehRqQ.js";
import { C as readRegistry, D as updateRegistry, E as updateBrowserRegistry, O as computeSandboxBrowserConfigHash, S as readBrowserRegistry, T as removeRegistryEntry, _ as resolveSandboxScopeKey, a as execDocker, c as isDockerDaemonUnavailable, d as readDockerNetworkDriver, f as readDockerNetworkGateway, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as removeBrowserRegistryEntry, y as slugifySessionKey } from "./docker-D3kv4KQ2.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Bzui_Q64.js";
import { C as buildPinnedMkdirpPlan, D as dockerSandboxBackendManager, E as buildPinnedWritePlan, O as runDockerSandboxShellCommand, T as buildPinnedRenamePlan, a as getSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedRemovePlan, y as normalizeContainerPath } from "./browser-bridges-DTUx4gcw.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-Blk-2aa_.js"),
				import("./exec-defaults-DvLGsOpt.js"),
				import("./skills-BP-HlRV_.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BKyzYqCA.js")).maybePruneSandboxes(cfg);
