...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-CO0vIOsX.js";
import { i as READ_SCOPE } from "./operator-scopes-B-FLT_xh.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-C8kfg-5n.js");
