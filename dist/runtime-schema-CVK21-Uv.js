...
import { t as CHANNEL_IDS } from "./ids-D3yDKGxF.js";
...
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-qSKtb3D6.js";
import { t as OpenClawSchema } from "./zod-schema-BZrPfVfY.js";
import { t as sensitive } from "./zod-schema.sensitive-CrsTTWWH.js";
import "./config-DgbftrzN.js";
import { r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-sfAAn6v-.js";
import { a as isSensitiveConfigPath } from "./redact-snapshot-kPnE6_be.js";
...
const FIELD_HELP = {
	...
	"agents.defaults.agentRuntime": "Default agent runtime policy. Omitted id uses built-in OpenClaw Pi. Use id=auto for plugin harness selection, a registered harness id such as codex, or a supported CLI backend alias such as claude-cli.",
	"agents.defaults.agentRuntime.id": "Agent runtime id: pi, auto, a registered plugin harness id such as codex, or a supported CLI backend alias such as claude-cli. Omitted id uses built-in OpenClaw Pi.",
	"agents.defaults.embeddedHarness": "Legacy input for agents.defaults.agentRuntime. Run openclaw doctor --fix to rewrite it to agentRuntime.",
	"agents.defaults.embeddedHarness.runtime": "Legacy input for agents.defaults.agentRuntime.id.",
	"agents.list.*.agentRuntime": "Per-agent agent runtime policy override. Use id=codex to force Codex for one agent while defaults stay in auto mode.",
	"agents.list.*.agentRuntime.id": "Per-agent agent runtime id: pi, auto, a registered plugin harness id such as codex, or a supported CLI backend alias such as claude-cli. Omitted id inherits the default OpenClaw Pi behavior.",
	"agents.list.*.embeddedHarness": "Legacy input for agents.list.*.agentRuntime. Run openclaw doctor --fix to rewrite it to agentRuntime.",
