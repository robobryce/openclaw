...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-BgzzIHyp.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-Xm-KEvst.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DQtMY1R7.js";
import { a as resolveSecretRefValue } from "./resolve-DZOk7mgl.js";
import { n as info, o as success, t as danger } from "./globals-BkYSZEKh.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-qSKtb3D6.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-CW8ofM72.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CVK21-Uv.js";
import { n as setCommandJsonMode } from "./json-mode-B7nZb2SH.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CxvCBQrB.js");
