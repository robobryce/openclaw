...
import { g as pathExists, r as writeExternalFileWithinRoot } from "./fs-safe-C91ZNyPb.js";
...
import { t as resolveSystemBin } from "./resolve-system-bin-De3GvXi1.js";
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-CryupCH5.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-C1DwuUBG.js";
import { t as describeImageWithModel } from "./image-runtime-9g0PLAMf.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-DOmAUQlT.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-BRHnlxQQ.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CBcAEjSu.js";
import { t as applyTemplate } from "./templating-CheRRX-D.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-Dp_ShE5a.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-Dau6yp-g.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-abB3a9GL.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
