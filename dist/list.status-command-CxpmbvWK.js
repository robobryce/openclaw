...
import { G as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-qSKtb3D6.js";
...
import { h as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-D-rkbyr1.js";
import { o as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-B5Dau954.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Djx4qmq3.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-9iDG1gb8.js";
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-BzVqn7Iy.js";
import { t as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CV6_uxAg.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DWZH91NY.js";
import { t as maskApiKey } from "./mask-api-key-BkErGmdK.js";
import { t as loadModelsConfig } from "./load-config-m2LYNCJt.js";
import { n as isRich } from "./list.format-B8OJLPPg.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-BtmMCN9K.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-BRgDwAI1.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-BvNYYrsj.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-hqpHGiAx.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-MwzdRMKS.js");
		runtime.log("");
